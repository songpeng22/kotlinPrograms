...
//function accept lambdas as parameter
inline fun convertFive(converter: (Int) -> Double) : Double {
...
inline fun getConversionLambda(str: String): DoubleConversion {
...
//crossinline do not use non-local return which is provided by inline function
inline fun combine(crossinline lambda1: DoubleConversion,
                   crossinline lambda2: DoubleConversion): DoubleConversion {
